...
(function ($) {
    $.loader_ext = {
        ...
        defaults: {
            ...
            title: '', //文字
            isOnly: true,
            imgUrl: $('meta[name="root-path"]').attr('content') + 'assets/vendors/jquery-loader/images/loading[size].gif',
            onShow: function () {
            },  //打开回调
            onClose: function () {
            }  //关闭回调
    ...
    // 简单开启关闭以及设置模板
    $.loader = {
        tmpl: '<div class="loading_wrp" style="z-index:10000;"><div class="loading ${Class}"><img src="${Src}" /><span>${Title}</span></div></div>',
