            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('admin/broadcast/showbiz') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-camera"></span> @lang('broadcast/form.showbiz')</a>
                    </div>
                    <div class="pull-right">
                        <a href="{{ URL::to('admin/broadcast/gaming') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-play"></span> @lang('broadcast/form.gaming')</a>
                    </div>
                    </div>
                                ...
                                @foreach ($broadcasts as $index => $broadcast)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ URL::to('admin/broadcast/' . $broadcast->id . '/connect' ) }}" class="btn btn-success btn-xs purple">@lang('broadcast/form.connect')</a>
                                            @endif
