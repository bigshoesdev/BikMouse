        ...
        <div class="row">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left"> <i class="livicon" data-name="play" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                        @lang('broadcast/form.gaming')
                    </h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div>
                            <a href="{{ URL::to('admin/broadcast/gaming') }}" class="btn btn-sm btn-warning btn-broadcast"><span class="glyphicon glyphicon-play"></span> @lang('broadcast/form.gaming')</a>
                            <a href="{{ URL::to('admin/broadcast/showbiz') }}" class="btn btn-sm btn-default btn-broadcast"><span class="glyphicon glyphicon-camera"></span> @lang('broadcast/form.showbiz')</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table" style="vertical-align: center;">
                            ...
                            <tr class="filters">
                                ...
                                <th>@lang('broadcast/form.classify')</th>
