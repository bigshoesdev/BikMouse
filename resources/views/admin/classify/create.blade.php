            ...
            <div class="col-lg-12">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('url' => URL::to('admin/classify'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true )) !!}
                        <input type="hidden" name="status" value=1 />
                        <div class="form-group {{ $errors->first('title', 'has-error') }}">
                            <label for="title" class="col-sm-2 control-label">
                                @lang('classify/form.classify_title')
                            </label>
                            <div class="col-sm-6">
                                {!! Form::text('title', null, array('class' => 'form-control', 'placeholder'=>trans('classify/form.classify_title'), 'rows' => 5)) !!}
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-10">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                        <img src="{{asset('assets/img/bigo/bigo_auto.png')}}" alt="Logo picture">
                                    </div>
